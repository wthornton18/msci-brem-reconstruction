...
class InitialModel:
    ...
    def train_model(self, model: keras.models.Sequential, training_data, train_labels, validation_data, validation_labels):
        ...
        all_histos: List[np.histogram] = [histo_training_s, histo_training_b, histo_testing_s, histo_testing_b]
        ...
        errorbar_testing_s = np.sqrt(histo_testing_s[0])/1000
        errorbar_testing_b = np.sqrt(histo_testing_b[0])/1000
    ...
    def generate_data_mapping(self):
        ...
        with uproot.open(self.filename) as file:
            ...
            electron_data_sets = []
            i = 0
            for data in tzip(tree['ElectronTrack_PX'].array(), 
